...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-md sm:max-w-xl md:max-w-2xl max-h-[92vh] rounded-t-3xl sm:rounded-2xl flex flex-col relative shadow-2xl overflow-hidden border border-slate-200">
        {/* Modal Top Header */}
          ...
          {step === 1 && (
            <div className="space-y-4 animate-in fade-in duration-150">
              ...
              <button
                id="btn-step1-next"
                onClick={() => setStep(2)}
                className="w-full py-3 bg-[#7C3AED] hover:bg-purple-700 text-white text-xs font-bold rounded-xl shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
            ...
            <div className="space-y-3.5 animate-in fade-in duration-150">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-[#7C3AED]"
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-8 pr-2 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-[#7C3AED]"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-[#7C3AED]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 focus:ring-2 focus:ring-[#7C3AED]"
                >
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  id="btn-step2-next"
                  onClick={() => setStep(3)}
                  className="flex-1 py-3 bg-[#7C3AED] hover:bg-purple-700 text-white text-xs font-bold rounded-xl shadow-sm flex items-center justify-center gap-2 cursor-pointer transition-colors"
                >
            ...
            <div className="space-y-4 animate-in fade-in duration-150">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80 space-y-2 text-xs">
                ...
                <div className="pt-2 border-t border-slate-200 flex justify-between text-sm font-black text-slate-900">
                  ...
                  <span className="text-[#7C3AED]">₹{totalDueAtMoveIn.toLocaleString()}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  ...
                  >
                    ...
                    <div className="text-sm font-black text-[#7C3AED] mt-1">₹{tokenAmount}</div>
                  ...
                  >
                    ...
                    <div className="text-sm font-black text-[#7C3AED] mt-1">
              ...
              <div>
                ...
                <div className="space-y-2">
                      ...
                      <div className="flex gap-2 pt-1">
                        {(['gpay', 'phonepe', 'paytm', 'qr'] as const).map((app) => (
                          <button
                            ...
                            className={`flex-1 py-2 text-[11px] font-bold uppercase rounded-lg border transition-all cursor-pointer ${
                              upiApp === app
                  ...
                  >
                    ...
                    <span className="text-[10px] text-slate-400 font-medium">Visa / MC / RuPay</span>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 bg-[#7C3AED] hover:bg-purple-700 disabled:bg-purple-300 text-white text-sm font-extrabold rounded-xl shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
                {isProcessing ? (
                  <div className="flex items-center gap-2">
            ...
            <div className="text-center space-y-4 animate-in zoom-in-95 duration-200">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5 text-left shadow-lg space-y-3 relative overflow-hidden border border-slate-800">
                ...
                <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-800 text-xs">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-[#B48CF8]">
              ...
              <div className="space-y-2 pt-2">
                <button
                  ...
                  className="w-full py-3 bg-[#7C3AED] hover:bg-purple-700 text-white text-xs font-bold rounded-xl shadow-sm transition-all cursor-pointer"
                >
